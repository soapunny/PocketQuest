...
const styles = StyleSheet.create({
  ...
  saveBtnText: { color: Colors.white, fontWeight: FontWeight.extrabold },
  saveBtnDisabled: { opacity: 0.6 },
  linkDisabled: { opacity: Opacity.faint },

  linkWrap: { marginTop: Spacing.lg },
  linkText: { color: Colors.gray600, fontWeight: FontWeight.semibold },
  ...
  savingsChipDeleteWrapDisabled: { opacity: Opacity.faint },
